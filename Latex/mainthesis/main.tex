...
\begin{table}[!h]
    \centering
    \caption{\label{tab:var_vifs} Final 13 variables resulting from variable selection with VIFs.}
    \centerline{
...
After computing all of the mentioned models and creating a TPR weighted ensemble, one can examine the development over time in more detail (Fig. \ref{fig:modelling_res}).

...
```{r, combine some niche year plots}
years = c("20022003", "20062007", "20102011", "20142015", "20181019", "20212022")
p = list()
for (i in 1:6) {
    p[[i]] <- readPNG(paste0("eu_", years[i], "_niche.png"))
}
layout(matrix(1:12,nr=4,byr=T))
for (j in 1:12) plot(p[[j]])
```
